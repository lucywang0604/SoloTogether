...
[
  ...
  },
  {
    ...
    profile: Profile.find_by(name: "James O'Connor"),
    photo_url: "https://images.unsplash.com/photo-1495474472287-4d71bcdd2085",
    filename: "london_street_art.jpg"
  },
  {
    ...
    profile: Profile.find_by(name: "Charlotte Wilson"),
    photo_url: "https://images.unsplash.com/photo-1470091688026-38b51162c8df",
  ...
  },
  {
    ...
    profile: Profile.find_by(name: "Benjamin Lee"),
    photo_url: "https://images.unsplash.com/photo-1465146344425-f00d5f5c8f07",
  ...
  },
  {
    ...
    profile: Profile.find_by(name: "Charlotte Wilson"),
    photo_url: "https://images.unsplash.com/photo-1499856871958-5b9627545d1a",
    filename: "paris_seine.jpg"
  },
  {
    ...
    profile: Profile.find_by(name: "Benjamin Lee"),
    photo_url: "https://images.unsplash.com/photo-1533900298318-6b8da08a523e",
    filename: "london_market.jpg"
  },
  {
    ...
    profile: Profile.find_by(name: "James O'Connor"),
    photo_url: "https://images.unsplash.com/photo-1500380804539-4e1e8c1e7118",
    filename: "london_architecture.jpg"
  },
  {
    ...
    filename: "paris_cafe_culture.jpg"
  }
].each do |post_data|
  post = Post.create!(
  ...
  begin
    post.photo.attach(
      io: URI.open(post_data[:photo_url]),
      filename: post_data[:filename],
      content_type: "image/jpg"
    )
  rescue OpenURI::HTTPError => e
    puts "Failed to attach photo for post '#{post_data[:title]}': #{e.message}"
  end
end
